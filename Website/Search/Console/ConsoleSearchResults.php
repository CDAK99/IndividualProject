 ...
 <head>
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
	  	<button class = "back" onclick='window.location.href="/Search/Console/ConsoleSearch.php"'><span>Back</span></button></br> 
		<h1>Search by Console Name</h1>
		<?php
		if ( isset( $_POST[ 'submit' ] ) )
		{
			...
			$query = "SELECT * FROM Console WHERE Console_Name = '" . $name . "';";
