 ...
 <head>
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
	  	<button class = "back" onclick='window.location.href="/Search/Game/ReleaseDateSearch.php"'><span>Back</span></button></br> 
		...
		if ( isset( $_POST[ 'submit' ] ) )
		{
			...
			$query = "SELECT * FROM Game, Developer, Publisher WHERE Game.Publisher = Publisher.Publisher_ID AND Game.Developer = Developer.Developer_ID AND Release_Date = '" .
			$releasedate . "';";
			...
			if (mysqli_num_rows($result) == 0){
				...
				echo '<p> <a href="'.$response.'" download="ReleaseDateSearchResults.csv">Download</a></p>';
				mysqli_close($link);
			}
		}
		?>
