 ...
 <head>
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
		<button class = "back" onclick='window.location.href="/Search/Game/DeveloperSearch.php"'><span>Back</span></button></br> 
		...
		if ( isset( $_POST[ 'submit' ] ) )
		{
			...
			$query = "SELECT * FROM Game, Developer, Publisher WHERE Game.Publisher = Publisher.Publisher_ID AND Game.Developer = Developer.Developer_ID AND Developer.Developer_Name = '" .
			$developer . "';";
			...
			if (mysqli_num_rows($result) == 0){
				...
				echo '<p> <a href="'.$response.'" download="DeveloperSearchResults.csv">Download</a></p>';
				mysqli_close($link);
			}
		}
		?>
