 ...
 <head>
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
		<button class = "back" onclick='window.location.href="/Search/Platform/ConsoleSearch.php"'><span>Back</span></button></br> 
		<h1>Search by Console Results</h1>
		<?php
		if ( isset( $_POST[ 'submit' ] ) )
		{
			...
			$query = "SELECT * FROM Platform, Game, Console WHERE Platform.Game_ID = Game.Game_ID AND Platform.Console_ID = Console.Console_ID AND Console.Console_Name = '" . $console . "';";
			...
			if (mysqli_num_rows($result) == 0){
				...
				echo '<p> <a href="'.$response.'" download="ConsoleSearchResults.csv">Download</a></p>';
				mysqli_close($link);
			}
		}
		?>
